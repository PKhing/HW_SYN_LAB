...
REM
REM Generated by Vivado on Mon Aug 22 21:20:32 +0700 2022
...
echo "xvlog --incr --relax -prj lab1_5_tester_vlog.prj"
call xvlog  --incr --relax -prj lab1_5_tester_vlog.prj -log xvlog.log
