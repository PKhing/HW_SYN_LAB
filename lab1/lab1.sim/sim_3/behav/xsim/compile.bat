...
REM
REM Generated by Vivado on Sat Aug 27 19:47:30 +0700 2022
...
echo "xvlog --incr --relax -prj DFlipFlopTester_vlog.prj"
call xvlog  --incr --relax -prj DFlipFlopTester_vlog.prj -log xvlog.log
