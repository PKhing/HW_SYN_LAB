...
REM
REM Generated by Vivado on Sat Aug 27 19:14:00 +0700 2022
...
echo "xvlog --incr --relax -prj fullAdderTester_vlog.prj"
call xvlog  --incr --relax -prj fullAdderTester_vlog.prj -log xvlog.log
