...
REM
REM Generated by Vivado on Sat Aug 27 19:51:06 +0700 2022
...
echo "xvlog --incr --relax -prj lab1_4_tester_vlog.prj"
call xvlog  --incr --relax -prj lab1_4_tester_vlog.prj -log xvlog.log
